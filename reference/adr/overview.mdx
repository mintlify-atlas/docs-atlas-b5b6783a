...
<CardGroup cols={2}>
  ...
  <Card title="Decouple from IETF" icon="link-slash" href="/reference/adr/decouple-ietf">
    **September 2022** - Decision to decouple from IETF standards process
  </Card>
  
  <Card title="Single-Value Annotations" icon="tag" href="/reference/adr/sva-prefix">
    **April 2023** - Supporting custom annotations via the `x-` prefix
  </Card>
  
  <Card title="Extract Unstable Keywords" icon="filter" href="/reference/adr/extract-unstable">
    **May 2024** - Extracting unstable features before stable release
  </Card>
  
  <Card title="Contains and Objects" icon="brackets-curly" href="/reference/adr/object-contains">
    **November 2023** - Decision on `contains` keyword scope for arrays vs objects
  </Card>
  
  <Card title="AdditionalProperties Ambiguity" icon="triangle-exclamation" href="/reference/adr/additionalproperties-ambiguity">
